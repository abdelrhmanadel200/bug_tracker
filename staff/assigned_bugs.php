...
<head>
    ...
    <title>My Assigned Bugs - BugTracker</title>
...
<body>
    ...
    <div class="container-fluid py-4">
            ...
            <div class="card-body">
                <form method="GET" action="" class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="assigned_bugs.php" class="btn btn-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header bg-light">
                <h5 class="mb-0">Assigned Bugs (<?php echo $total_bugs; ?>)</h5>
            </div>
            <div class="card-body">
