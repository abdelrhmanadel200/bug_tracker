...
if ($assigned_filter === 'unassigned') {
    $query .= " AND b.assigned_to IS NULL";
} elseif ($assigned_filter === 'assigned') {
    $query .= " AND b.assigned_to IS NOT NULL";
}
...
$count_query = "SELECT COUNT(*) as total FROM bugs b WHERE 1=1";
$count_params = [];

if (!empty($status_filter)) {
    if ($status_filter === 'open') {
        $count_query .= " AND b.status NOT IN (?, ?)";
        $count_params[] = STATUS_CLOSED;
        $count_params[] = STATUS_RESOLVED;
    } else {
...
if ($assigned_filter === 'unassigned') {
    $count_query .= " AND b.assigned_to IS NULL";
} elseif ($assigned_filter === 'assigned') {
    $count_query .= " AND b.assigned_to IS NOT NULL";
}
...
<head>
    ...
    <title>All Bugs - BugTracker</title>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="GET" action="" class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label for="assigned" class="form-label">Assignment Status</label>
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        ...
                        <a href="all_bugs.php" class="btn btn-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center mt-4">
                            <li class="page-item <?php echo $page <= 1 ? 'disabled' : ''; ?>">
                                <a class="page-link" href="?page=<?php echo $page - 1; ?>&status=<?php echo $status_filter; ?>&priority=<?php echo $priority_filter; ?>&project_id=<?php echo $project_filter; ?>&assigned=<?php echo $assigned_filter; ?>">
                                    Previous
                                </a>
                            </li>
                            ...
                            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                <li class="page-item <?php echo $page == $i ? 'active' : ''; ?>">
                                    <a class="page-link" href="?page=<?php echo $i; ?>&status=<?php echo $status_filter; ?>&priority=<?php echo $priority_filter; ?>&project_id=<?php echo $project_filter; ?>&assigned=<?php echo $assigned_filter; ?>">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                            <?php endfor; ?>
