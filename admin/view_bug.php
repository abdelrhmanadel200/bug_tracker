...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Validate input - Fix: Check if keys exist before accessing them
...
<head>
    ...
    <title><?php echo $new_mode ? 'Create New Bug' : ($edit_mode ? 'Edit Bug #' . $ticket_number : 'Bug #' . $ticket_number); ?> - BugTracker</title>
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($screenshot)): ?>
                                <div class="mt-4">
                                    <h5>Screenshot</h5>
                                    <a href="../uploads/screenshots/<?php echo $screenshot; ?>" target="_blank" class="d-inline-block">
                                        <img src="../uploads/screenshots/<?php echo $screenshot; ?>" alt="Bug Screenshot" class="img-thumbnail" style="max-width: 100%; max-height: 300px;">
                                    </a>
                                </div>
                            <?php endif; ?>
                        </div>
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <?php if (!empty($comment['profile_image'])): ?>
                                                        <img src="../uploads/profile/<?php echo $comment['profile_image']; ?>" alt="Profile" class="rounded-circle" width="40" height="40">
                                                    <?php else: ?>
                                                        <div class="rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                                                            <?php echo strtoupper(substr($comment['fullname'], 0, 1)); ?>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            <h6 class="mb-0"><?php echo htmlspecialchars($comment['fullname']); ?></h6>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="text-muted small">
                                                    by <?php echo htmlspecialchars($entry['fullname']); ?> (<?php echo ucfirst($entry['role']); ?>)
                                                </div>
                                            </div>
                                            <div class="text-muted small">
...
<Actions>
  <Action name="Update my_bugs.php" description="Apply similar fixes to my_bugs.php to check for undefined array keys" />
  <Action name="Update projects.php" description="Apply similar fixes to projects.php to check for undefined array keys" />
  <Action name="Update users.php" description="Apply similar fixes to users.php to check for undefined array keys" />
  <Action name="Update reports.php" description="Apply similar fixes to reports.php to check for undefined array keys" />
  <Action name="Create error handling function" description="Create a reusable function to safely get POST/GET values with defaults" />
</Actions>
