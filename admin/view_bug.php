...
<head>
    ...
    <title><?php echo $new_mode ? 'Create New Bug' : ($edit_mode ? 'Edit Bug #' . htmlspecialchars($ticket_number) : ($assign_mode ? 'Assign Bug #' . htmlspecialchars($ticket_number) : 'Bug #' . htmlspecialchars($ticket_number))); ?> - BugTracker</title>
        ...
        <?php elseif ($assign_mode): ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-header bg-primary text-white">
                            <h5 class="mb-0">Assign to Staff Member</h5>
                        </div>
                        <div class="card-body">
                            <?php if (!empty($errors)): ?>
                                <div class="alert alert-danger">
